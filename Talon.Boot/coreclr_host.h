...
using talon_managed_init_fn = void(__stdcall*)(
    void* start_info_json,
    void* main_thread_continue_event,
    void* initialization_cancelled_event,
    void* initialization_state);
